...
insert into employee values (1,'prabhanshu'),(2,'raju'),(3,'rahul');
...
select concat("prabhanshu  ","singh");
select concat_ws("-","prabhanshu","singh");
...
select substring("prabhanshusingh",2,6);
select substr("prabhanshusingh",2,6);
...
select reverse("prabhanshu")from dual;
select lpad("pratu",20,"kaa");
SELECT MID("SQL Tutorial", 5, 3) AS ExtractString;
select repeat("pra",3);
select length("pra");
SELECT FORMAT(250500.5634, 2);
select lower("PRABHANSHU");
